...
export default function Dmlfcmp({imgd}) {
    ...
    return (
      ...
      <Dblue title={"SPI Slave UVM environment"}para={"I have build a complete UVM environment for verifying SPI_Slave with a single port RAM. I have also designed the golden model for checking the output with it. The waveforms and the UVM packages were used through Questa Sim tool."}img={spi}linka={"https://github.com/m7md5303/SPI_UVM"}/>
      <Dyellow title={"ALS_Unit Verification"} para={"A 5-operation Arithmetic Logic unit was verified using system verilog. Suitable stimulus wase generated with the company of constraint blocks to check the design functionality. The design perforam==mance was watched through the wave form generated by Questa Sim."}img={alsv}linka={"https://github.com/m7md5303/ALSU-SV-Verification"}/>
