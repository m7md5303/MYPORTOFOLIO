...
export default function Dmlfccmp({imgd}) {
    ...
    return (
       ...
       <Fade delay={200}><Dbluec title={"Learn to build OVM & UVM Testbenches from scratch"} para={"The course was introduced by Udemy platform. It covered the UVM structure and components. The course included UVM concepts such as TLM ports and FIFOs as well along with inter-communication between the UVM components."} img={uvm}/></Fade>
