...
export default function Emlfcmp({imgd}) {
    ...
    return (
      ...
      <Fade delay={200}><Dblue title={"WatchDog Atmega 32 Driver"} para={"A watchDog driver was implemented with C Language to set up the WatchDog timer for Atmega 32 controller. "} img={riskv} linka={"https://github.com/m7md5303/Watchdog_Atmega32_driver"}/></Fade>
      <Fade delay={200}><Dyellow title={"Stepper Motor Driver"} para={"A stepper motor driver was implemented with C Language. It was then connected to Atmega 32 Controller to test the functionality."} img={alsu} linka={"https://github.com/m7md5303/Stepper_Driver"}/></Fade>   
      <Fade delay={200}><Dbluec title={"Smart Garage"} para={"I participated in the hardware and the garage design implementation. The project was based on Arduino Controller. Our team won the 2nd place in the competition that was associated with Beta Academy Robotics Workshop."} img={scc} /></Fade>
