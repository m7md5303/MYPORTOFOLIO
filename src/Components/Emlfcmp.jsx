...
export default function Emlfcmp({imgd}) {
    ...
    return (
      ...
      <Dyellow title={"Flex-sensor-based Lock"}para={"A door lock based on values determined through flex sensor position. I was responsible for the coding and hardware implementation of the lock controller determining whether opening or no as well as giving the option when the password is correct to reclos again through a sliding switch. It was implemented using C programming, Atmega 32 controller, servo motor, switch and LEDs"}img={flex}linka={"https://github.com/m7md5303/Lock-controller"}/>
