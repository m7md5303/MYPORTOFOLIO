...
export default function Emlfccmp({imgd}) {
    ...
    return (
       ...
       <Dyellowc title={"Embedded Systems base on AVR Diploma"}para={"  The Diploma was provided by IMT School. It covered many important topics concerning Embedded Systems. The diploma content covered : \n-C Programming Language.\n-Embedded Systems Concepts.\n-Atmega 32 Interfacing.\n-Introduction to Software Testing with mentioning some techniques.\n-RTOS Basics.\n-Serial Communications protocols such as:\nUART.\nI2C.\nCAN.\nSPI.\nLIN."} img={dd}/>
